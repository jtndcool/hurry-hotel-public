...
@Repository
public class GetListOfHotelRepoImpl implements GetListOfHotelRepo {
	...
	public List<Hotel> getListofHotels(String city) {
		String query = HurryHotelConstant.QueryGetAvailableHotels;
		List<Hotel> hotelList = new ArrayList<>();
		try {
			hotelList = namedParameterJdbcTemplate.query(query, new MapSqlParameterSource().addValue(HurryHotelConstant.city, city), new RowMapper<Hotel>() {
